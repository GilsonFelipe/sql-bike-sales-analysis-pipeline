...
Script Purpose:
   This script creates all required views in the 'gold' schema. The Gold layer represents the final dimension and fact tables (Star Schema),
...
-- Create gold.fact_sales_details
